                        ...
                        return (
                            <li
                                ...
                                className={`
                                    ...
                                    ${isActive 
                                        ? 'border-rose-500 dark:border-rose-300 bg-gray-100 dark:bg-white/5 text-rose-500 dark:text-rose-300 font-bold' 
                                        : 'border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-white/5 text-gray-600 dark:text-gray-400'
                                    }
                                `}
                            >
                                {exp.company}
                    ...
                    <div className="animate-fade-in px-2">
                        ...
                        <ul className="space-y-3">
                            {experience.bullets?.map((bullet, index) => (
                                ...
                                >
                                    <svg 
                                        className="w-3 h-3 min-w-[12px] sm:w-3.5 sm:h-3.5 text-rose-500 dark:text-rose-300 mr-2 mt-[2px] fill-current" 
                                        viewBox="0 0 24 24"
                                    >
