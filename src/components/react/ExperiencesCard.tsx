...
export default function ExperiencesCard({ experiences }: Props) {
    ...
    return (
        <div className="flex flex-col md:flex-row items-start gap-4 font-jetbrains text-[#657b83] dark:text-[#93a1a1]">
                        ...
                        return (
                            <li
                                ...
                                className={`
                                    ...
                                    ${isActive
                                        /* Aba Ativa: Fundo de destaque (base2/base02) e borda/texto Magenta */
                                        ? 'border-[#d33682] dark:border-[#d33682] bg-[#eee8d5] dark:bg-[#073642] text-[#d33682] dark:text-[#d33682] font-bold'
                                        /* Aba Inativa: Fundo transparente, borda/texto suaves, efeito hover com fundo de destaque */
                                        : 'border-[#93a1a1] dark:border-[#586e75] hover:bg-[#eee8d5] dark:hover:bg-[#073642] text-[#657b83] dark:text-[#839496]'
                                    }
                                `}
                            >
                                {exp.company}
            ...
            <div className="w-full md:w-2/3 min-h-[300px]">
                {experience && (
                    <div className="animate-fade-in px-2">
                        ...
                        <div className="mb-4 text-xs sm:text-sm font-semibold text-[#657b83] dark:text-[#93a1a1]">
                        ...
                        <ul className="space-y-3">
                            {experience.bullets?.map((bullet, index) => (
                                <li
                                    key={index}
                                    className="flex items-start text-[11px] sm:text-sm leading-relaxed text-[#657b83] dark:text-[#93a1a1]"
                                >
                                    <svg
                                        className="w-3 h-3 min-w-[12px] sm:w-3.5 sm:h-3.5 text-[#d33682] dark:text-[#d33682] mr-2 mt-[2px] fill-current"
                                        viewBox="0 0 24 24"
                                    >
