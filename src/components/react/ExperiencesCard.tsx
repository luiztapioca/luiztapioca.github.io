                        ...
                        return (
                            <li
                                ...
                                className={`
                                    ...
                                    ${isActive 
                                        ? 'border-rose-400 bg-gray-100 dark:bg-white/5 text-rose-400 dark:text-rose-300 font-bold' 
                    ...
                    <div className="animate-fade-in px-2">
                        ...
                        <ul className="space-y-3">
                            {experience.bullets?.map((bullet, index) => (
                                ...
                                >
                                    <svg 
                                        className="w-3 h-3 min-w-[12px] sm:w-3.5 sm:h-3.5 text-rose-400 mr-2 mt-[2px] fill-current" 
                                        viewBox="0 0 24 24"
                                    >
